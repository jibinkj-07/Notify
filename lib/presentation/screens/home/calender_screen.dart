...
import 'package:notify/presentation/widgets/calendar/calendar_message_send.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<EventFileHandlerCubit, EventFileHandlerState>(
      builder: (context, state) {
        ...
        if (state.filePath != '') {
          userEvents = eventProvider.readDataFromFile(filePath: state.filePath);
        }
                  ...
                  Navigator.push(
                    ...
                    PageTransition(
                      ...
                      child: CalendarMessageSend(
                          sharingDateTime: _selectedDay,
                          userAllEvents: userEvents),
                    ),
                  );
                },
                icon: const Icon(
                ...
                child: (_eventsFromCalendar[DateTime(_selectedDay.year,
                    ...
                    ? Expanded(
                        child: ListView.builder(
                          ...
                          itemCount: _eventsFromCalendar[DateTime(
                                      _selectedDay.year,
                                      _selectedDay.month,
                                      _selectedDay.day)
                                  .toString()]!
